...
# ---------------------------------------------------------------------------
# Memory-optimized recommendation engine (merged from recommendation_engine_optimized.py)
# ---------------------------------------------------------------------------
...
class OptimizedRecommendationEngine:
    ...
    async def _process_candidates_batched(
        ...
        if self._batch_processor:
            ...
            # Fallback: simple batching without adaptive processor
            batch_size = 50
            for i in range(0, len(candidates), batch_size):
                batch = candidates[i:i + batch_size]
    ...
    def _extract_opportunities_simple(self, momentum_5d: float, volume_ratio: float) -> List[str]:
